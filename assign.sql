...
-- q3
select booking_id, user_id, match_id, coalesce(payment_status, 'Action Required') as systemic_status  from bookings
...
select u.user_id, u.full_name, b.booking_id from bookings as b
